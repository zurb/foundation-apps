(function() {
   ...
   */
    ...
    .directive('zfIfPortrait', zfIf('portriate'))
   ...
   */
    ...
    .directive('zfShowPortrait', zfShow('portriate'))
   ...
   */
    ...
    .directive('zfHidePortrait', zfHide('portriate'))
  ...
  function zfQueryWrapper(angularDirective, directiveName, namedQuery, queryOnly, queryNot) {
    ...
    function zfQueryDirective($compile, foundationApi) {
      ...
      var queryResult = (directiveName + foundationApi.generateUuid()).replace(/-/g,'');
      ...
      function compile(element, attrs) {
        ...
        // check if value was given to directive attribute, if so pass to ngIf
